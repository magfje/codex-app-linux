...
function patchDynamicToolThreadStartBridge(source, patch = findDynamicToolThreadStartBridgePatch(source)) {
  ...
  const helper = source.includes(dynamicToolThreadStartBridgeMarker)
    ? ""
    : [
        `function ${dynamicToolThreadStartBridgeMarker}(e){if(e?.method!==\`thread/start\`||e.params==null)return e;let t=__codexLinuxNormalizeThreadStartBridgeValue(e.params);return{...e,params:{...t,...Array.isArray(t.dynamicTools)?{dynamicTools:__codexLinuxNormalizeThreadStartBridgeDynamicTools(t.dynamicTools)}:{}}}}`,
        ...
        `function __codexLinuxNormalizeThreadStartBridgeDynamicTool(e,t=!0){e=__codexLinuxNormalizeThreadStartBridgeValue(e);if(e==null||typeof e!==\`object\`||e.type!=null&&e.type!==\`function\`||typeof e.name!==\`string\`)return null;let{namespace:n,input_schema:r,parameters:i,exposeToContext:a,defer_loading:o,tools:s,...c}=e,l=c.deferLoading??o??(a==null?!1:!a);return{...c,type:\`function\`,description:typeof c.description===\`string\`?c.description:\`\`,inputSchema:c.inputSchema??r??i??{type:\`object\`,properties:{},additionalProperties:!1},deferLoading:t&&l}}`,
        `function __codexLinuxNormalizeThreadStartBridgeDynamicTools(e){let t=[],n=new Map,r=(e,r,i)=>{let a=n.get(e);a||(a={type:\`namespace\`,name:e,description:typeof r===\`string\`?r:\`\`,tools:[]},n.set(e,a),t.push(a));for(let e of i){let t=__codexLinuxNormalizeThreadStartBridgeDynamicTool(e);t&&a.tools.push(t)}};for(let n of e){if(n?.type===\`namespace\`&&Array.isArray(n.tools)&&typeof n.name===\`string\`){r(n.name,n.description,n.tools);continue}let e=typeof n?.namespace===\`string\`&&n.namespace?n.namespace:null,i=__codexLinuxNormalizeThreadStartBridgeDynamicTool(n,e!=null);i&&(e?r(e,\`\`,[i]):t.push(i))}return t}`
      ].join("");
  const replacements = patch.patches.map(target => {
...
function patchDynamicToolThreadStartRequest(source, patch = findDynamicToolThreadStartRequestPatch(source)) {
  ...
  const helper = source.includes(dynamicToolThreadStartRequestMarker)
    ? ""
    : [
        `function ${dynamicToolThreadStartRequestMarker}(e){if(e==null||!Array.isArray(e.dynamicTools))return e;return{...e,dynamicTools:__codexLinuxNormalizeThreadStartRequestDynamicTools(e.dynamicTools)}}function __codexLinuxNormalizeThreadStartRequestDynamicTool(e,t=!0){if(e==null||typeof e!==\`object\`||e.type!=null&&e.type!==\`function\`||typeof e.name!==\`string\`)return null;let{namespace:n,input_schema:r,parameters:i,exposeToContext:a,defer_loading:o,tools:s,...c}=e,l=c.deferLoading??o??(a==null?!1:!a);return{...c,type:\`function\`,description:typeof c.description===\`string\`?c.description:\`\`,inputSchema:c.inputSchema??r??i??{type:\`object\`,properties:{},additionalProperties:!1},deferLoading:t&&l}}function __codexLinuxNormalizeThreadStartRequestDynamicTools(e){let t=[],n=new Map,r=(e,r,i)=>{let a=n.get(e);a||(a={type:\`namespace\`,name:e,description:typeof r===\`string\`?r:\`\`,tools:[]},n.set(e,a),t.push(a));for(let e of i){let t=__codexLinuxNormalizeThreadStartRequestDynamicTool(e);t&&a.tools.push(t)}};for(let n of e){if(n?.type===\`namespace\`&&Array.isArray(n.tools)&&typeof n.name===\`string\`){r(n.name,n.description,n.tools);continue}let e=typeof n?.namespace===\`string\`&&n.namespace?n.namespace:null,i=__codexLinuxNormalizeThreadStartRequestDynamicTool(n,e!=null);i&&(e?r(e,\`\`,[i]):t.push(i))}return t}`
      ].join("");
  const replacements = patch.patches.map(target => {
